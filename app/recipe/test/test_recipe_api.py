...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_partial_update(self):
        ...
        original_link = 'https://example.com/recipa.pdf'
    ...
    def test_create_tag_on_update(self):
        ...
        self.assertIn(new_tag, recipe.tags.all())  # this line refresh db
...
class ImageUploadTests(TestCase):
    ...
    def tearDown(self):  # Delete image
